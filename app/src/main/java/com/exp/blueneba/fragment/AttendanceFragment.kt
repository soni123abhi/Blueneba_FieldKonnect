...
import com.exp.blueneba.activity.AttendanceActivity
...
import com.exp.blueneba.helper.GPSTracker
import com.exp.blueneba.helper.StaticSharedpreference
import com.exp.blueneba.model.*
import com.exp.blueneba.worker.LocationForegroundService
import com.exp.blueneba.worker.WorkerLocation
...
class AttendanceFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(com.exp.blueneba.R.layout.fragment_attendance, container, false)
    ...
    private fun initViews() {
        linearSelectedPlan = rootView.findViewById(com.exp.blueneba.R.id.linearSelectedPlan)
        spinnerCity = rootView.findViewById(com.exp.blueneba.R.id.spinnerCity)
        imgPunchIn = rootView.findViewById(com.exp.blueneba.R.id.imgPunchIn)
        tvPunchInTime = rootView.findViewById(com.exp.blueneba.R.id.tvPunchInTime)
        tvPunchInDate = rootView.findViewById(com.exp.blueneba.R.id.tvPunchInDate)
        imgPunchOut = rootView.findViewById(com.exp.blueneba.R.id.imgPunchOut)
        tvPunchOutDate = rootView.findViewById(com.exp.blueneba.R.id.tvPunchOutDate)
        tvPunchOutTime = rootView.findViewById(com.exp.blueneba.R.id.tvPunchOutTime)
        cardPunchInMain = rootView.findViewById(com.exp.blueneba.R.id.cardPunchInMain)
        cardPunchOutMain = rootView.findViewById(com.exp.blueneba.R.id.cardPunchOutMain)
        cardBurger = rootView.findViewById(com.exp.blueneba.R.id.cardBurger)
        relativeMainPunch = rootView.findViewById(com.exp.blueneba.R.id.relativeMainPunch)
        imgCamera = rootView.findViewById(com.exp.blueneba.R.id.imgCamera)
        cardSubmit = rootView.findViewById(com.exp.blueneba.R.id.cardSubmit)
        tvPunchIn = rootView.findViewById(com.exp.blueneba.R.id.tvPunchIn)
        spinnerPlan = rootView.findViewById(com.exp.blueneba.R.id.spinnerPlan)
        linearPlan = rootView.findViewById(com.exp.blueneba.R.id.linearPlan)
        spinnerBeat = rootView.findViewById(com.exp.blueneba.R.id.spinnerBeat)

        tvObjective = rootView.findViewById(com.exp.blueneba.R.id.tvObjective)
        tvType = rootView.findViewById(com.exp.blueneba.R.id.tvType)
        tvCity = rootView.findViewById(com.exp.blueneba.R.id.tvCity)

        tvObjectiveS = rootView.findViewById(com.exp.blueneba.R.id.tvObjectiveS)
        tvTypeS = rootView.findViewById(com.exp.blueneba.R.id.tvTypeS)
        tvCityS = rootView.findViewById(com.exp.blueneba.R.id.tvCityS)
        tvDateS = rootView.findViewById(com.exp.blueneba.R.id.tvDateS)
    ...
    override fun onClick(p0: View) {
        when (p0.id) {
            com.exp.blueneba.R.id.imgCamera -> {
            ...
            com.exp.blueneba.R.id.cardSubmit -> {
            ...
            com.exp.blueneba.R.id.cardBurger -> {
    ...
    fun checkInDialog(activity: Activity, tv: String) {
        ...
        val mDialogView = LayoutInflater.from(activity).inflate(com.exp.blueneba.R.layout.dialog_checkin_summary, null)
        //AlertDialogBuilder
            ...
            object : APIResultLitener<JsonObject> {
                override fun onAPIResult(response: Response<JsonObject>?, errorMessage: String?) {
                    ...
                    if (response != null && errorMessage == null) {
                        ...
                        Toast.makeText(
                            activityLocal,
                            resources.getString(com.exp.blueneba.R.string.poor_connection),
                            Toast.LENGTH_LONG
                        ).show()
                    }
                }
            ...
            object : APIResultLitener<JsonObject> {
                override fun onAPIResult(response: Response<JsonObject>?, errorMessage: String?) {
                    ...
                    if (response != null && errorMessage == null) {
                        ...
                        //  dialog.dismiss()
                        Toast.makeText(activityLocal, resources.getString(com.exp.blueneba.R.string.poor_connection), Toast.LENGTH_LONG).show()
                    }
                }
            })
    }
